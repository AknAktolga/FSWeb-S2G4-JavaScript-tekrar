...
let sayilarDizisindekiElemanlarinSayisi = sayilar.length;
console.log(sayilarDizisindekiElemanlarinSayisi);
...
const ucebolunenlerintoplami = ucetambolunenler.reduce(function(a, b) {
  return a + b;
}, 0);
